...
Last, we will briefly highlight the `tidySingleCellExperiment` package (<https://stemangiola.github.io/tidySingleCellExperiment>) that allows you to leverage functions from `dplyr`, `tidyr`, and `ggplot2` with a `SingleCellExperiment` object. 
